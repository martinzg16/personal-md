 ...
 * room for it.
 *
 * It shares its stylesheet with the app, which is the whole reason this file
 * exists alongside the document-world one. That surface's own header made the
 * point: a shared stylesheet is a shared brand, and moving one without the other
 * leaves the second rendering its old classes against the new ground. So Brío's
 * popup rides Brío's sheet, and the document popup keeps riding the document's.
 *
